# This script is intended to remove all a single resource group
...
Write-Host  "WARNING: This script will delete all resources in the resource group you specify in the prompt below" -ForegroundColor Red -BackgroundColor Yellow
            "`n"
